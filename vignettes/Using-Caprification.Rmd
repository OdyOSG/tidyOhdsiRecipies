...
## Note on Capr Dependency

This vignette demonstrates features that require the Capr package. If Capr is not installed, you can install it from GitHub:
...
Without Capr installed, the functions demonstrated in this vignette will not work and will prompt you to install the package.
